<!DOCTYPE html>
	<html>
		...
		<body>
		 <div class="container">
		 	<header>
					<img src="image/bannière.jpg" alt=" La bannière de notre guilde" width="100%" />
					<center> <h1> Bienvenue sur le site de la Guilde Elegeia </h1> </center>
					<center> <p> Il n'y a pas de mort, il n'y a que ... le centre médical </p> </center>
				...
				<center> <h2> Presentations de la guilde Elegeia </h2> </center>
				...
				<center> <h2> Membres principal ranger par rang </h2> </center>
				<div class="row">
					<div class="col-md-6">
						<center> <h2 class="GM"> Drake </h2> </center>
					</div>
					<div class="col-md-6">
						<center> <h2 class="GM"> Zekras </h2> </center>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3">
						<center> <h2 class="membres"> Lissa </h2> </center>
					</div>
					<div class="col-md-3">
						<center> <h2 class="membres"> Techito </h2> </center>
					</div>
					<div class="col-md-3">
						<center> <h2 class="membres"> Félice </h2> </center>
					</div>
					<div class="col-md-3">
						<center> <h2 class="membres"> Korwor </h2> </center>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3">
						<center> <h2 class="membres"> Andossei </h2> </center>
					</div>
					<div class="col-md-3">
						<center> <h2 class="membres"> Cookie </h2> </center>
					</div>
					<div class="col-md-3">
						<center> <h2 class="membres"> Zaan </h2> </center>
					</div>
					<div class="col-md-3">
						<center> <h2 class="membres"> Serix </h2> </center>
					</div>
				</div>
				<center> <h2> Presentation du jeux </h2> </center>
				<p> Star Wars: The Old Republic (abrégé SWTOR et prononcé SWoTOR) est un jeu vidéo de rôle en ligne massivement multijoueur basé sur l'univers étendu de Star Wars. Il a été développé par BioWare, édité par LucasArts, et ouvert aux joueurs le 20 décembre 2011 sur Windows.
				Il s'agit du second MMO sur l'univers Star Wars (le premier étant Star Wars Galaxies, lancé en 2003 et fermé pour le lancement de SWTOR le 15 décembre 2011) ; ainsi que du deuxième jeu vidéo Star Wars signé BioWare (le premier étant le jeu de rôle Knights of the Old Republic sorti en 2003).
				</p>
				<div class="row">
					<div class="col-md-6">
						<img src="image/republics.png" width="100%" height="200px">
					</div>
					<div class="col-md-6">
						<img src="image/empire.png" width="100%" height="200px">
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
